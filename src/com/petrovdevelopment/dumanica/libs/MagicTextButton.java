package com.petrovdevelopment.dumanica.libs;
...
public class MagicTextButton extends Button {
	...
	public MagicTextButton(Context context) {
		super(context);
		init(null);
	}

	public MagicTextButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
	}

	public MagicTextButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(attrs);
	}

	public void init(AttributeSet attrs) {
		//Added by ANDREY. Set the font to Obelix
		setTypeface(Typeface.createFromAsset(getContext().getAssets(), ASSETS_FONT_LOCATION));
		...
		if (attrs != null) {
			...
			if (a.hasValue(R.styleable.MagicTextView_innerShadowColor)) {
				this.addInnerShadow(a.getFloat(R.styleable.MagicTextView_innerShadowRadius, 0),
						a.getFloat(R.styleable.MagicTextView_innerShadowDx, 0), a.getFloat(R.styleable.MagicTextView_innerShadowDy, 0),
			...
			if (a.hasValue(R.styleable.MagicTextView_outerShadowColor)) {
				this.addOuterShadow(a.getFloat(R.styleable.MagicTextView_outerShadowRadius, 0),
						a.getFloat(R.styleable.MagicTextView_outerShadowDx, 0), a.getFloat(R.styleable.MagicTextView_outerShadowDy, 0),
			...
			a.recycle(); //mark the arguments array for garbage collection
		}
	}
